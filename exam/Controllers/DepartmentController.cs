...
namespace exam.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,name,code,location,numberOfPersonals")] DepartmentModel departmentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,name,code,location,numberOfPersonals")] DepartmentModel departmentModel)
        {
