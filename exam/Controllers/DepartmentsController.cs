...
namespace exam.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,name,code,location,NumberOfPersonal")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,code,location,NumberOfPersonal")] Department department)
        {
            if (id != department.id)
            {
                return NotFound();
